# From https://github.com/microsoft/computervision-recipes/blob/master/utils_cv/action_recognition/dataset.py
import os
import copy
import math
...
import transforms_video as transforms
from functional_video import denormalize

from misc import Config
from gpu import num_devices, db_num_workers
...
class VideoDataset:
    ...
    def __getitem__(self, idx: int) -> Tuple[torch.tensor, int]:  # Tuple
        """
        Return:
